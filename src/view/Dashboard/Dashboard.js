    ...
    <div id="wrapper">
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li className="nav-item active">
                <Link className="nav-link" replace to="/">
            ...
            <li className="nav-item">
                <Link className="nav-link" replace to="/ubookpackage">
            ...
            <li className="nav-item">
                <Link className="nav-link" replace to="/uviewbooking">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <Link class="dropdown-item" replace to="/uprofile">
            ...
            {/* <div className="container-fluid">
                ...
                <ViewHotelBookings imgCard="" destination="Goa" prize="25000.00" description="3D/2N"/>
            </div> */}
