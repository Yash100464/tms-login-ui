    ...
    <div id="wrapper">
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            {/* <li className="nav-item">
                <Link className="nav-link" to="/abookpackage">
            ...
            {/* <li className="nav-item">
                <Link className="nav-link" to="/aviewbooking">
                    <i className="fas fa-fw fa-chart-area"></i>
                    <span>View Bookings</span></Link>
            </li> */}
            ...
            <li className="nav-item">
                <Link className="nav-link" replace to="/aaddpackage">
                    <i className="fas fa-fw fa-chart-area"></i>
            ...
            {/* <!-- Nav Item - Tables --> */}
            <li className="nav-item">
                <Link className="nav-link" to="/aviewaddedpackage">
                    <i className="fas fa-fw fa-table"></i>
