...
import {BiRupee} from "react-icons/bi";
 const AddedPackageCard = ({detail,imgLink="https://images.unsplash.com/photo-1536323760109-ca8c07450053?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NjJ8fHRyYXZlbHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=600&q=60"}) => {
    return(
        ...
        <div class="card profile-card-5">
            ...
            <button type="button" className="btn btn-success pl-4">Edit</button>
            <span>  </span>
 ...
 export default AddedPackageCard;
